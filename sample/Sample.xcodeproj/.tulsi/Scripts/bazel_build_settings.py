...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_zhuge/3ebbac24d31e4e076867a63328c9fd57/execroot/__main__',
    'ios_x86_64',
    {
        'watchos_i386': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/zhuge/Library/Application Support/Tulsi/0.4.208887017.20180815/Bazel',
    ...
    BazelFlagsSet(
        flags = BazelFlags(
            ...
            build = [
                '--apple_generate_dsym',
                '--copt=-fdebug-prefix-map=/private/var/tmp/_bazel_zhuge/3ebbac24d31e4e076867a63328c9fd57/execroot/__main__=/Users/zhuge/Desktop/BazelDemo',
            ],
        ),
    ),
    BazelFlagsSet(
